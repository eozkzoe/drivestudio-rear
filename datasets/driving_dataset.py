...
class DrivingDataset(SceneDataset):
    def __init__(
        ...
        #   PandaSet: 6 Cameras
        #   NuPlan:   8 Cameras
        self.dataset_type = self.data_cfg.dataset
        ...
        self.invert_rear_cams = self.data_cfg.invert_rear_cams
        self.layout = get_layout(self.dataset_type, self.invert_rear_cams)
    ...
    def prepare_novel_view_render_data(self, traj: torch.Tensor) -> list:
        ...
        return self.pixel_source.prepare_novel_view_render_data(self.dataset_type, traj)
